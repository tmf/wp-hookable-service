...
class HookableServiceProvider implements ServiceProviderInterface
{
   ...
   */
  protected $initializeMethodsByHook = array();
   ...
   * @param array $initializeMethodsByHook a list of entry points: each value containing a method name of the
   ...
   */
  public function __construct($serviceKey, $serviceClass, $initializeMethodsByHook = array('init' => 'initialize'))
  {
    $this->serviceKey = $serviceKey;
    $this->serviceClass = $serviceClass;
    $this->initializeMethodsByHook = $initializeMethodsByHook;
  }
  ...
  public function register(Container $container)
  {
    ...
    foreach ($this->initializeMethodsByHook as $hook => $method) {
      $this->hookService($hook, $method, $container, $serviceKey);
    }
  }
   ...
   */
  protected function hookService($hook, $method, $container, $serviceKey)
  {
    // always register with priority 10
    $priority = 10;
